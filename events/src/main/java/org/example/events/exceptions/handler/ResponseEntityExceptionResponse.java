package org.example.events.exceptions.handler;
...
public class ResponseEntityExceptionResponse {
    ...
    public ResponseEntity<ExceptionResponse> handleCepNotFoundException(CepNotFoundException e, WebRequest request) {
        ExceptionResponse res = new ExceptionResponse(LocalDate.now(), e.getMessage(), request.getDescription(false));
